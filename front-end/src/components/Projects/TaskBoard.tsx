...
//   useEffect(() => {
//     setTasks(ALL_TASKS.filter((t) => t.projectId === projectId));
//   }, [projectId]);
...
//       <KanbanColumn title="Backlog" tasks={tasks.filter(t => t.status === "backlog")} onDropTask={moveTask}/>
//       <KanbanColumn title="Todo" tasks={tasks.filter(t => t.status === "todo")} onDropTask={moveTask}/>
//       <KanbanColumn title="In Progress" tasks={tasks.filter(t => t.status === "inprogress")} onDropTask={moveTask}/>
//       <KanbanColumn title="Done" tasks={tasks.filter(t => t.status === "done")} onDropTask={moveTask} />
//     </div>
//   );
// };
